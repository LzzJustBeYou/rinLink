...
```bash
# 删除app目录下的错误文件
rm -rf /Users/rinzel/rinzel_code/android/RinLink/app/src/main/java/com/example
rm -rf /Users/rinzel/rinzel_code/android/RinLink/app/src/main/java/com/rinzelLink

# 删除core目录下的错误文件
rm -rf /Users/rinzel/rinzel_code/android/RinLink/core/src/main/java/com/example

# 删除modules目录下的错误文件
rm -rf /Users/rinzel/rinzel_code/android/RinLink/modules/*/src/main/java/com/example
```
...
│       ├── MainActivity.kt
│       ├── RinLinkApplication.kt
│       └── di/AppModule.kt
├── core/
│   └── src/main/java/com/rinzelLink/core/
│       ├── device/
│       ├── module/
│       ├── room/
│       ├── group/
...
└── modules/
    ...
    ├── ble/
    └── mqtt/
    └── src/main/java/com/rinzelLink/modules/[module_name]/
```
